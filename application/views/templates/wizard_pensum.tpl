								...
								{for $num=1 to $semestre}
									<div class="accordion-group">
										<div class="accordion-heading">
											<a href="#collapse{$num}" data-parent="#accordion2" data-toggle="collapse" class="accordion-toggle collapsed">
												<span style="font-size: 16px;">Semestre #{$num}</span>
											</a>
										</div>

										<div class="accordion-body collapse" id="collapse{$num}">
