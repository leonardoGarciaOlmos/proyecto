...
*/
//domain iuspo.com.ve
$config['DX_recaptcha_public_key'] = '6LeV5-oSAAAAAMcsFNA9ofW2uXdXcm2ruwRdvrx_'; 
$config['DX_recaptcha_private_key'] = '6LeV5-oSAAAAAIqQ4DpSvQiz6UD6BiK2kb33muaK';
...
$config['DX_deny_uri'] = '/auth';
$config['DX_login_uri'] = '/auth';
...
$config['DX_logged_in_view'] = 'auth/perfil';
